...
// Terminal / ops-log aesthetic — fits a video about surviving your first 100
// users. Monospace, scanlines, live typing, a self-assembling "survive()"
// function, script-driven step icons, a progress bar, and an outro CTA.
...
const SIG: Tok[] = [
  { t: "def ", c: SYN.kw },
  { t: "survive_first_100_users", c: SYN.fn },
  { t: "():", c: SYN.pun },
];
const CALL_POOL: Tok[] = [
  { t: "    ", c: SYN.pun },
  { t: "pool_connections", c: SYN.call },
  { t: "(", c: SYN.pun },
  { t: "limit", c: SYN.arg },
  { t: "=", c: SYN.pun },
  { t: "10", c: SYN.str },
...
const CALL_CACHE: Tok[] = [
  { t: "    ", c: SYN.pun },
  { t: "add_cache_layer", c: SYN.call },
  { t: "(", c: SYN.pun },
  { t: "redis", c: SYN.arg },
  { t: ")", c: SYN.pun },
];
    ...
    <AbsoluteFill style={{ alignItems: "center", paddingTop: 205 }}>
      ...
      >
        ...
        >
          ...
          <span style={{ color: SYN.cmt, fontSize: 22, marginLeft: 12 }}>scale.py</span>
        </div>
...
const HOOK_BEAT: ImageBeatMeta = {
  id: "hook",
  file: "first-100-users/images/hook-db-lock.jpg",
  label: "THE PROBLEM: connection limit",
  width: 1000,
  bottom: 120,
};
const STEP_BEATS: ImageBeatMeta[] = [
  {
    id: "step1",
    file: "first-100-users/images/step1-pooling.jpg",
    label: "STEP 1: connection pooling",
    width: 1000,
    bottom: 120,
  },
  {
    id: "step2",
    file: "first-100-users/images/step2-cache.jpg",
    label: "STEP 2: caching layer",
    width: 1000,
    bottom: 120,
  },
  {
    id: "step3",
    file: "first-100-users/images/step3-loadtest.jpg",
    label: "STEP 3: load test",
    width: 1000,
    bottom: 120,
  },
];
  ...
  const codeLines: CodeLine[] =
    stepRanges.length === 3
      ? [
          ...
          { atFrame: stepRanges[0].start + 20, toks: CALL_POOL },
          { atFrame: stepRanges[1].start, toks: CALL_CACHE },
          { atFrame: stepRanges[2].start, toks: CALL_LOAD },
